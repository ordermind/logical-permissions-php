...
interface LogicalPermissionsInterface {
  ...
  * @param callable $callback The callback that evaluates access bypassing. Upon calling checkAccess() the registered bypass callback will be passed one parameter, which is the $context parameter passed to checkAccess(). It should return a boolean which determines whether bypass access should be granted.
  */
