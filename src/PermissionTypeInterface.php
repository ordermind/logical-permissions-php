...
interface PermissionTypeInterface
{
     ...
     *
     * @param string            $permission The permission to check, for example "admin" if the permission type is
     * "role". The permission will always be a single string even if for example multiple roles are accepted. In that
     * case this method will be called once for each role that is to be evaluated.
     *
