...
This is a package that provides support for array-based permissions with logic gates such as AND and OR. You can register any kind of permission types such as roles and flags. The idea with this package is to be an ultra-flexible foundation that can be used by any framework. 
